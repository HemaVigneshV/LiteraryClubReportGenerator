...
import { FiPlus, FiFileText, FiClock, FiCheckCircle, FiXCircle, FiUpload } from 'react-icons/fi';
    ...
    <div className="page-container animate-fade-in">
      ...
      <div className="stats-bar">
        ...
        <div className="stat-card" onClick={() => setFilter('draft')}>
          <div className="stat-value" style={{ color: 'var(--status-draft)' }}>{stats.draft}</div>
